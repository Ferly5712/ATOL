                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Pelanggan <small>Tambah Pelanggan</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form action="tambah_pelanggan_proses.php" method="POST" role="form">
                                    <div class="form-group">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td><input class="form-control" name="email"><p class="help-block"></p></td>
                                            </tr>
                                            <tr>
                                                <td><label>no_hp</label></td>
                                                <td><input class="form-control" name="no_hp"><p class="help-block"></p></td>
                                            </tr>
                                            <tr>
